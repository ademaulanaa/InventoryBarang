      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?menu=kelola_pegawai">Kelola User</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="?menu=kelola_pegawai" class="list-group-item"><span class="fa fa-list-alt" aria-hidden="true"></span> Kelola User <span class="badge"><i class="fa fa-user"></i></span></a>
