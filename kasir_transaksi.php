            ...
            if ($jumlah < 1) {
                ...
                if ($sisa['stok_barang'] < $jumlah) {
                    ...
                    if ($num > 0 ) {
                        ...
                        header("location:admin.php?menu=transaksi");
                    }else{
            ...
            <div class="modal-body">
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="admin.php?menu=transaksi&beli&id=<?php echo $brs['kd_barang'] ?>"><?php echo $brs['kd_barang'] ?></a></td>
...
<script>
    $(document).ready(function(){
        $('#harga, #jum').keyup(function(){
            calculateTotal();
        });

        function calculateTotal() {
            var harga = parseFloat($('#harga').val());
            var jumlah = parseInt($('#jum').val());
